ninja.translator = {
	...
	translations: {
		...
		"es": {
			...
			"detaillabelnote2": "Dash almacena las claves públicas comprimidas. El cliente también soporta importar/exportar claves privadas usando importprivkey/dumpprivkey. El formato de las claves privadas exportadas depende de si la dirección se generó en una cartera antigua o nueva.",
		...
		"fr": {
			...
			"singletip4": "Vérifier le contenu de votre porte-monnaie en consultant explorer.dash.org et en y tapant votre adresse de réception Dash.",
	    ...
	    "de": {
			...
			"detaillabelnote2": "Ab Version 0.6 speichert Dash-qt &ouml;ffentliche Schl&uuml;ssel komprimiert. Dash Programm unterst&uuml;tzt nun auch den Import und Export von privaten Schl&uuml;sseln mit importprivkey/dumpprivkey. Dash Format des exportierten privaten Schl&uuml;ssels h&auml;ngt davon ab, ob die Adresse in einem alten oder neuen Wallet erstellt wurde.",
		...
		"cs": {
			...
			"bulklabela2li3": "Umožněte na vaší stránce platbu pomocí Dash. Stačí vždy zobrazit jednu z vygenerovaných adres a uložit si ji u objednávky.",
			...
			"bulklabela2li5": "Dash budou bezpečně převedeny v řetězci bloků. Pro spotřebování stačí kdykoliv naimportovat soubor vygenerovaný v prvním kroku.",
		...
		"hu": {  // 02-MAR-2014 16:57
			...
			"brainalertpassphrasewarning": "Figyelem: Fontos, hogy erős jelmondatot válasszon, mert különben a jelmondatot nyers erővel feltörhetik és a Dash ellophatják.",
		...
		"jp": {	
			...
			"bulklabela2li4": "後は支払いの通知を受けないと注文を通すか否か分かりません。グーグルで「Dash payment notification」と検索したら、SMS、メール、APIなどでDashの支払いがあった際教えてくれます。これをコードの中に組み込んで、支払いがあったら注文を通すようにもできます。手動で送金があったかを見る場合、http://explorer.dash.org に行き、宛先のアドレスを入力すれば、取引履歴から送金の事実を確認できます。大体送金の30秒後に表示され、10分～1時間の間に「確認」されます。",
		...
		"zh-cn": {	
			...
			"singletip4": "<b>查询余额：</b> 访问explorer.dash.org可以查看到任何地址中的世币余额。",
			...
			"bulka1": "例如，当你建设一个世币收款网站，需要分别为每一个用户准备一个收款地址时，传统的做法是使用世币客户端“dashd”生成大量的地址，但是不一定所有的网站托管都支持它。另外，你在服务器上运行世币客户端，也就意味着你的私钥也会保存在服务器上，当骇客攻破服务器时，你的世币可能会被盗。使用批量钱包一次生成大量的钱包，只把生成的地址放在服务器上，即使服务器被攻破，也不必担心世币的安全。",
        ...
        "ru": {
            ...
            "bulklabela2li2": "Импортируйте биткоин адреса в базу данных или иное хранилище Вашего веб-сервера. (Не размещайте приватные ключи кошелька на Вашем веб-сервере, в противном случае Вы рискуете потерять свои биткоины. Своим клиентам Вам достаточно предоставить Dash адрес.)",
